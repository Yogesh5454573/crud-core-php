                                    ...
                                    <?php foreach ($rows as $row): ?>
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap; display: flex; align-items: center; gap: 10px;">
                                                <a href="editAdmin.php?id=<?php echo $row['id']; ?>" class="fa fa-edit"
                                                    style="font-size: 20px; color: blue;" title="Edit Admin"></a>
                                                <a href="deleteAdmin.php?id=<?php echo $row['id']; ?>" class="material-icons"
                                                    style="font-size: 22px; color: red;"
                                                    onclick="return confirm('Are you sure you want to delete this Admin?');"
                                                    title="Delete Admin">delete</a>
                                                <a href="copyAdmin.php?id=<?php echo $row['id']; ?>" class="fa fa-copy"
                                                    style="font-size: 20px; color: green;"
                                                    onclick="return confirm('Are you sure you want to copy this Admin?');"
                                                    title="Copy Admin"></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
